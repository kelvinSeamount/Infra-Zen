...
Go to `https://github.com/kelvinSeamount/zen-infra-pharam.git`

```bash
git clone https://github.com/kelvinSeamount/zen-infra-pharam.git
cd zen-infra
```
...
rds_endpoint     = "pharma-dev-postgres.xxxxxxxx.eu-central-1.rds.amazonaws.com"
```
...
| Public Subnet 1 | `10.0.1.0/24` (eu-central-1a) | NAT Gateway, Load Balancers |
| Public Subnet 2 | `10.0.2.0/24` (eu-central-1b) | NAT Gateway, Load Balancers |
| Private EKS Subnet 1 | `10.0.3.0/24` (eu-central-1a) | EKS worker nodes |
| Private EKS Subnet 2 | `10.0.4.0/24` (eu-central-1b) | EKS worker nodes |
| Private RDS Subnet 1 | `10.0.5.0/24` (eu-central-1a) | RDS PostgreSQL |
| Private RDS Subnet 2 | `10.0.6.0/24` (eu-central-1b) | RDS PostgreSQL |
...
### 16.1 Create a Fine-Grained PAT (Recommended)
